...
namespace PactIncreasedLethality
{
    public class T72 : Module
    {
        ...
        static MelonPreferences_Entry<int> k5_conversion_chance;
        ...
        public static GameObject t72b_k1_full;
        ...
        public static void Config(MelonPreferences_Category cfg)
        {
            ...
            k5_conversion_chance = cfg.CreateEntry<int>("Conversion chance for K5 T-72 (%)", 25);
            k5_conversion_chance.Comment = "Changes (based on percent amount) T-72M1V's into T-72M1M's and T-72B 1985's into T-72B 1989's, requires both kontakt types to be enabled.";
        ...
        public static IEnumerator Convert(GameState _)
        {
            foreach (Vehicle vic in Mod.vics)
            {
                ...
                bool k5_eligible = (k5_t72m1.Value && is_t72m1) || (k5_t72m.Value && is_t72m);

                bool has_k5 = k5_eligible && UnityEngine.Random.Range(0, 100) < k5_conversion_chance.Value;
