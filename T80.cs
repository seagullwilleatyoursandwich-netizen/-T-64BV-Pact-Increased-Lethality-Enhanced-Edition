...
namespace PactIncreasedLethality
{
    public class T80 : Module
    {
        ...
        static MelonPreferences_Entry<int> t80u_conversion_chance;
        ...
        public static GameObject t80bv_full;
        ...
        public static void Config(MelonPreferences_Category cfg)
        {
            ...
            // CHANGE 1: Quick Zoom Switch now defaults to true
            ...
            kontakt5.Comment = "T-80U conversion. If enabled with Kontakt-1, a percentage of T-80BVs will become T-80Us.";

            t80u_conversion_chance = cfg.CreateEntry<int>("T-80U Conversion Chance (%)", 30);
            t80u_conversion_chance.Comment = "Chance for a Kontakt-1 T-80BV to become a Kontakt-5 T-80U";
        ...
        public static IEnumerator Convert(GameState _)
        {
            foreach (Vehicle vic in Mod.vics)
            {
                ...
                if (kontakt1.Value && kontakt5.Value)
                {
                    is_t80u = UnityEngine.Random.Range(0, 100) < t80u_conversion_chance.Value;
                }
                ...
                if (kontakt5.Value && is_t80u)
                {
                    ...
                    if (!reticleSO)
                    {
                        ...
                        // CHANGE 2: Removed redundant constructor instantiation for cached object
        ...
        // CHANGE 3: Added the UnloadDynamicAssets asset lifecycle override method
